...
export const useDashboardData = (userState, userDispatch, statusState) => {
  ...
  const loadQuotaData = useCallback(async () => {
    ...
    try {
      ...
      if (isAdminUser) {
        url = `/api/data/?username=${username}&start_timestamp=${localStartTimestamp}&end_timestamp=${localEndTimestamp}&default_time=${dataExportDefaultTime}&token_name=${token_name}`;
      } else {
        url = `/api/data/self/?start_timestamp=${localStartTimestamp}&end_timestamp=${localEndTimestamp}&default_time=${dataExportDefaultTime}&token_name=${token_name}`;
      }
