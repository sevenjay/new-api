...
export const useTokenAnalyticsData = (userState, userDispatch, statusState) => {
  ...
  const loadQuotaData = useCallback(async () => {
    ...
    try {
      ...
      if (isAdminUser) {
        url = `/api/data/?username=${username}&start_timestamp=${localStartTimestamp}&end_timestamp=${localEndTimestamp}&default_time=${dataExportDefaultTime}&group_by=token`;
      } else {
        url = `/api/data/self/?start_timestamp=${localStartTimestamp}&end_timestamp=${localEndTimestamp}&default_time=${dataExportDefaultTime}&group_by=token`;
      }
