...
import { Route as AuthenticatedTokenAnalyticsIndexRouteImport } from './routes/_authenticated/token-analytics/index'
...
const AuthenticatedTokenAnalyticsIndexRoute =
  AuthenticatedTokenAnalyticsIndexRouteImport.update({
    id: '/token-analytics/',
...
export interface FileRoutesByFullPath {
  ...
  '/token-analytics/': typeof AuthenticatedTokenAnalyticsIndexRoute
...
export interface FileRoutesById {
  ...
  '/_authenticated/token-analytics/': typeof AuthenticatedTokenAnalyticsIndexRoute
...
export interface FileRouteTypes {
  ...
  id:
    ...
    | '/_authenticated/system-settings/'
    | '/_authenticated/token-analytics/'
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_authenticated/token-analytics/': {
      id: '/_authenticated/token-analytics/'
      path: '/token-analytics'
      fullPath: '/token-analytics/'
      preLoaderRoute: typeof AuthenticatedTokenAnalyticsIndexRouteImport
      parentRoute: typeof AuthenticatedRouteRoute
    }
    '/_authenticated/usage-logs/': {
...
interface AuthenticatedRouteRouteChildren {
  ...
  AuthenticatedTokenAnalyticsIndexRoute: typeof AuthenticatedTokenAnalyticsIndexRoute
...
const AuthenticatedRouteRouteChildren: AuthenticatedRouteRouteChildren = {
  ...
  AuthenticatedTokenAnalyticsIndexRoute: AuthenticatedTokenAnalyticsIndexRoute,
